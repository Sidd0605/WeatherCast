...
public class AqiFragment extends Fragment {
    ...
    public void getCoords(String CityName){
        String url = "https://api.openweathermap.org/data/2.5/weather?q="+CityName+"&appid=a8f8615db968d9904aefb443fbd54aa8";
    ...
    public void apiAqi(String CityName){
        String url = "https://api.waqi.info/feed/"+CityName+"/?token=b1d92fbada42767a24c5507f4c253a7a6294a819";
        JsonObjectRequest jor = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
    ...
    public void apiUvi(){
        String url = "https://api.openweathermap.org/data/3.0/onecall?lat="+latitude+"&lon="+longitude+"&exclude=hourly,daily&appid=a8f8615db968d9904aefb443fbd54aa8";
        JsonObjectRequest jor = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @SuppressLint("SetTextI18n")
            public void onResponse(JSONObject response) {
                try {
